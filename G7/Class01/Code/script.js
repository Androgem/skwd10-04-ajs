...
const startEx04 = 150;
const endEx04 = 2570;  // you can use prompt to input start and end number
...
console.log(cleanAllButNumbers([true, false, 12, 12, 44, "Bob", undefined, "Jill", false, "", 99, NaN, null, 1, 22]));
