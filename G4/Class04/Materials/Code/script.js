...
console.log(sumTo(3));
console.log(sumToE(4));


let aleksandarArr = ["Gregori", "Todot", "Bojan", "Darko", "Erika", "Milena"];
...
function getNumber(arr, num){
    ...
    return arr[num] += num + " - " + getNumber( aleksandarArr, num + 1);
}

console.log(getNumber(aleksandarArr, 0));
