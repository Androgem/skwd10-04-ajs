...
//fourth parameter ist the array .reduce() is called on
...
function increaseByOneImpure(array) {
    let result = [];
...
function increaseByOneImpure2() {
    for(let i = 0; i < numbers.length; i++) {
        numbers[i] += 1;
    }
}

increaseByOneImpure2();
console.log("after calling the function ", numbers);
